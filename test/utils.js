...
describe('Utils', function() {
  ...
  describe('#privateKeyToAESKey', function() {
    it('should be ok', function() {
      var privKey = new Mangacore.PrivateKey('09458c090a69a38368975fb68115df2f4b0ab7d1bc463fc60c67aa1730641d6c').toString();
  ...
  describe('#verifyRequestPubKey', function() {
    it('should generate and check request pub key', function() {
      var reqPubKey = (new Mangacore.PrivateKey).toPublicKey();
      var xPrivKey = new Mangacore.HDPrivateKey();
      var xPubKey = new Mangacore.HDPublicKey(xPrivKey);
    ...
    it('should fail to check a request pub key with wrong key', function() {
      ...
      var xPrivKey2 = new Mangacore.HDPrivateKey();
      var xPubKey2 = new Mangacore.HDPublicKey(xPrivKey2);
